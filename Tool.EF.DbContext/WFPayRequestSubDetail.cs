...
namespace Tool.EF.DbContext
{
    ...
    public partial class WFPayRequestSubDetail
    {
        public int WFPayRequestSubDetailId { get; set; }
        public Nullable<int> WFPayRequestDetailId { get; set; }
        ...
        public virtual WFPayRequestDetail WFPayRequestDetail { get; set; }
    }
}
